---
description: End a session by updating the persistent brain files for omm-plants. Usage: /wrap-up
---
...
Write a new `.brain/handoff.md` with this structure:
